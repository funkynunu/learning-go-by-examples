...
import (
	...
	"github.com/funkynunu/learning-go-by-examples/go_rest_api/pkg/swagger/server/restapi"
	"github.com/funkynunu/learning-go-by-examples/go_rest_api/pkg/swagger/server/restapi/operations"
...
func main() {
	...
	// Start server which is listening
